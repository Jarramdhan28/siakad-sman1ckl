<x-admin-layout>
  <div class="pb-6 pt-1">
      <span class="font-bold text-4xl">Halaman Data Nilai Akhir</span>
  </div>
          ...
          <table id="datatable" class="stripe hover" style="width:100%; padding-top: 1em;  padding-bottom: 1em;">
              <thead class="bg-gray-100">
                  <tr>
                      ...
                      <th scope="col" class="px-6 py-3">Nilai Pengetahuan</th>
                      <th scope="col" class="px-6 py-3">Nilai Keterampilan</th>
