<x-admin-layout>
    <div class="pb-6 pt-1">
        <p class="font-bold md:text-5xl text-2xl">Halaman Tambah Data Nilai Akhir</span></p>
        <p class="text-gray-500 py-1 text-xs md:text-lg">Silahkan Masukan Nilai Akhir yang sesuai</p>
    </div>
