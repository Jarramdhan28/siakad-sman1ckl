<x-admin-layout>
    ...
    <div class="w-full max-w-xll p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-6 md:p-8">
        ...
        >
            ...
            <div x-show="tabActive === 'tugas'" x-data="{ dataTugas: [] }" x-init="$watch('dataNilai', function(nilai){
                dataTugas = [];
                if(nilai.tugas){
                    nilai.tugas.forEach((_, i) => i > 0 ? dataTugas.push(Math.random()) : '')
                }
            })">
            ...
            <div x-show="tabActive === 'ulangan'" x-data="{ dataUlangan: [] }" x-init="$watch('dataNilai', function(nilai){
                dataUlangan = [];
                if(nilai.ulangan){
                    nilai.ulangan.forEach((_, i) => i > 0 ? dataUlangan.push(Math.random()) : '')
                }
            })">
