<x-siswa-layout>
  <div class="pb-6 pt-1">
      <span class="font-bold text-4xl">Hallo, <span class="font-semibold">{{ auth('siswa')->user()->nama_siswa}}</span></span>
      <p class="text-gray-500 py-1 text-xs md:text-lg">Selamat datang di SMAN 1 Cikalong</p>
  </div>
