<x-siswa-layout>
  <div class="pb-6 pt-1">
      <p class="font-bold md:text-5xl text-2xl">Halaman Daftar Nilai Akhir</p>
    <p class="text-gray-500 py-1 text-xs md:text-lg">Dalam daftar nilai akhir terdapat Nilai Pengetahuan dan Nilai Keterampilan</p>
  </div>
