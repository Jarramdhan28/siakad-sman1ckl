<x-admin-layout>
    <div class="pb-6 pt-1">
        <p class="font-bold md:text-5xl text-2xl">Halaman Ubah Data Guru</p>
        <p class="text-gray-500 py-1 text-xs md:text-lg">Silahkan Ubah Data Guru yang Salah Menjadi Benar</p>
    </div>
    ...
    <div class="w-full max-w-xll p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-6 md:p-8">
        <form method="POST" action="{{ route('guru.update', $guru->id) }}">
            ...
            <div class="mt-4">
                ...
                <x-text-input id="nip" class="block mt-1 w-full" type="number" name="nip" value="{{ $guru->nip }}" required autofocus autocomplete="nip" />
            ...
            <div class="mt-4">
                ...
                <x-text-input id="text-input" class="block mt-1 w-full" type="text" name="nama_guru" value="{{ $guru->nama_guru }}" required autofocus autocomplete="nama_guru" />
            ...
            <div class="mt-4">
                ...
                <x-text-input id="no_hp" class="block mt-1 w-full" type="number" name="no_hp" value="{{ $guru->no_hp }}" required autofocus autocomplete="no_hp" />
