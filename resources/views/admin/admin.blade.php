<x-admin-layout>
    <div class="pb-6 pt-1">
        <p class="font-bold md:text-5xl text-2xl">Halaman Data Admin</p>
        <p class="text-gray-500 py-1 text-xs md:text-lg">Ini merupakan Data Adminn yang ada di SMAN 1 Cikalong</p>
    </div>
    ...
    <div class="bg-white shadow-xl rounded-xl py-4 px-7 border border-gray-100">
        ...
        @endif
        <div class="pb-6">
            <x-blue-button href="{{ route('admin.create') }}">Tambah Data Admin</x-blue-button>
        </div>
        <div>
                    ...
                    @foreach ($admin as $data )
                        <tr class="bg-white hover:bg-gray-100">
                            ...
                            <td class="text-center">
                                <x-success-button href="{{ route('admin.edit', $data->id) }}">Ubah</x-success-button>
