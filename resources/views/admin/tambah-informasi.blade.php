<x-admin-layout>
    <div class="pb-6 pt-1">
        <p class="font-bold md:text-5xl text-2xl">Halaman Tambah Informasi Sekolah</p>
        <p class="text-gray-500 py-1 text-xs md:text-lg">Silahkan Tuliskan Informasi Terbaru</p>
    </div>
    ...
    <div class="w-full max-w-xll p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-6 md:p-8">
        <form method="POST" action="{{ route('informasi.store') }}">
            ...
            <div>
                ...
                <textarea name="isi" id="isi" rows="20" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm"></textarea>
