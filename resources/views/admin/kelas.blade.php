<x-admin-layout>
    ...
    <div class="bg-white shadow-xl rounded-xl py-4 px-7 border border-gray-100">
        ...
        @endif
        <div class="pb-6">
            <a href="{{ route('kelas.create') }}" class="inline-flex items-center px-4 py-2 bg-blue-800 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-blue-700 focus:bg-blue-700 active:bg-blue-900 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 transition ease-in-out duration-150">Tambah Data Kelas</a>
        </div>
        <div>
                    ...
                    @foreach ($kelas as $data )
                        <tr>
                            ...
                            <td class="text-center">
                                <x-success-button href="{{ route('kelas.edit', $data->id) }}">Ubah</x-success-button>
