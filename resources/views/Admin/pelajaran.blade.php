<x-admin-layout>
    <div class="pb-6 pt-1">
        <span class="font-bold text-4xl">Halaman Data Pelajaran</span>
    </div>
    ...
    <div class="pb-6">
        <a href="{{ route('formPelajaran') }}" class="inline-flex items-center px-4 py-2 bg-blue-800 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-blue-700 focus:bg-blue-700 active:bg-blue-900 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 transition ease-in-out duration-150">Tambah Data Pelajaran</a>
    </div>

    <div>
        <table id="pelajaranTable" class="table-auto">
